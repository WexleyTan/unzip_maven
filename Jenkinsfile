pipeline {
    ...
    environment {
        ...
        GIT_BRANCH = "master"
        GIT_MANIFEST_REPO = "https://github.com/WexleyTan/unzip_maven_manifest.git"
        MANIFEST_REPO = "unzip_maven_manifest"
                    ...
                    dir("${MANIFEST_REPO}") {
                        ...
                        withCredentials([usernamePassword(credentialsId: GIT_CREDENTIALS_ID, passwordVariable: 'GIT_PASS', usernameVariable: 'GIT_USER')]) {
                            sh """
                                ...
                                git push https://${GIT_USER}:${GIT_PASS}@github.com/WexleyTan/unzip_maven_manifest ${GIT_BRANCH}
                            """
                        }
                    }
                }
